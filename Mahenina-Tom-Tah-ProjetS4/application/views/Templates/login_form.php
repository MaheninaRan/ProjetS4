            ...
            <legend><h2 class="text-center">Login</h2></legend>
                <div class="tab-pane active" id="tabs-1" role="tabpanel">
                    <div class="signin__form__text">
                        ...
                        <form action="<?php echo site_url('index.php/testeC/checklogin');?>" method="post">
                           <div class="row">
                                 <input class="col-md-9 col-md-offset-1" type="text" placeholder="Votre Adresse electronique" name="email" value="lava@gmail.com">
                           </div> 
                            <div class="row">
                                <input class="col-md-9 col-md-offset-1" type="password" placeholder="Votre mot de passe" id="myInput" name="password" value="lava"> 
                                <input class="col-md-1 col-md-offset-1" id="pwd" type="checkbox" onclick="myFunction()">
                            </div>
